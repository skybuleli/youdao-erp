...
详见 [docs/design/ui-design-spec.md](./docs/design/ui-design-spec.md)
...
| 文档 | 内容 |
|------|------|
| [docs/API.md](./docs/API.md) | 完整接口文档（含 Request/Response 示例） |
| [docs/DEPLOY.md](./docs/DEPLOY.md) | 生产环境部署操作手册 |
| [docs/SEED.md](./docs/SEED.md) | 数据库种子数据说明 |
| [docs/IMPLEMENTATION_GUIDE.md](./docs/IMPLEMENTATION_GUIDE.md) | 项目实施路线图 |
| [docs/design/ui-design-spec.md](./docs/design/ui-design-spec.md) | UI 视觉设计规范 |
